...
const routes = [
  ...
  {path:'/verification/verify', name:'verify',component:page('auth/verification/verify.vue')},
  ...
  {path:'/password/reset/:token', name:'password.reset',component:page('auth/password/reset-password.vue')},

  {path:'/designs/create', name:'designs.create',component:page('user/designs/create.vue')},
